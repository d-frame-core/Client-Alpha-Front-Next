      ...
      <Dialog
        ...
        <DialogContent>
          ...
          <div className='mt-4 m-auto w-[500px] text-[20px]'>
            ...
            <p className='w-[100%] my-2'>
              <span className='text-gray-700 font-semibold mr-4'>Per Day</span>:{' '}
        ...
        <DialogActions>
          ...
          {!editAd ? (
            ...
            <Button onClick={editAdFunction}>Save Edit</Button>
          )}
          {!editBid ? (
            <Button onClick={() => setEditBid(true)}>Edit Bid</Button>
          ) : (
            <Button onClick={() => setEditBid(false)}>Close Edit</Button>
          )}
        </DialogActions>
      </Dialog>
    </div>
