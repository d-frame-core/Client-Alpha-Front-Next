...
function Sidebar() {
  ...
  return (
    <div className="w-[100%] h-[100vh] bg-gradient-to-b from-indigo-700 via-sky-600 to-cyan-500 shadow border border-black">
      {/* logo */}
      <div>
        <Image src='/dframe.png' alt="logo" width={100} height={100} className='mx-auto mt-4'/>
        <p className='text-center mt-2 text-[24px] font-bold text-[#0A194E]'>D Frame</p>
      </div>
      ...
      {/* simple Tabs */}
        ...
        <div className='bg-[#1B2B65] w-[85%] mx-auto mt-20 rounded-lg text-center text-white pb-2'>
          <div className='relative'>
            ...
            <div className='m-auto  bg-[#1B2B65] w-8 h-8 pt-[3px] text-[20px] rounded-full'><p>?</p></div>
            </div>
          </div>
        ...
        <Link href="/learnMore"><p className='text-center text-black mt-8 font-semibold underline text-md'>Learn More</p></Link>
